...
public class TodoWriteToolApplication {

	private static final Logger log = LoggerFactory.getLogger(TodoWriteToolApplication.class);

	public static void main(String[] args) {
		SpringApplication.run(TodoWriteToolApplication.class, args);
	}
