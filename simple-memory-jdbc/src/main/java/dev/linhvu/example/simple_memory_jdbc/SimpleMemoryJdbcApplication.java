...
public class SimpleMemoryJdbcApplication {

	private static final Logger log = LoggerFactory.getLogger(SimpleMemoryJdbcApplication.class);

	public static void main(String[] args) {
		SpringApplication.run(SimpleMemoryJdbcApplication.class, args);
	}
