...
public class AutoMemoryToolApplication {

	private static final Logger log = LoggerFactory.getLogger(AutoMemoryToolApplication.class);

	public static void main(String[] args) {
		SpringApplication.run(AutoMemoryToolApplication.class, args);
	}
