...
public class LocalModeljarsApplication {

	private static final Logger log = LoggerFactory.getLogger(LocalModeljarsApplication.class);

	public static void main(String[] args) {
		SpringApplication.run(LocalModeljarsApplication.class, args);
	}
