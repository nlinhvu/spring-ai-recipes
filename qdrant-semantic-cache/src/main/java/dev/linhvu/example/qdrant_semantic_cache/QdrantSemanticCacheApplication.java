...
public class QdrantSemanticCacheApplication {

	private static final Logger log = LoggerFactory.getLogger(QdrantSemanticCacheApplication.class);

	public static void main(String[] args) {
		SpringApplication.run(QdrantSemanticCacheApplication.class, args);
	}
